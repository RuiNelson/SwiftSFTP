...
///
/// The default `reason` of `11` corresponds to `SSH_DISCONNECT_BY_APPLICATION`. The `language` tag follows the IETF
/// `RFC 5646` style (for example `en-US`); pass an empty string when localization is not relevant.
///
/// - Parameters:
