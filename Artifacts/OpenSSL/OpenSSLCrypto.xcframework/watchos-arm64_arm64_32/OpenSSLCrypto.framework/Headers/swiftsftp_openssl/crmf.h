...
#include <OpenSSLCrypto/swiftsftp_openssl/crmferr.h>
#include <OpenSSLCrypto/swiftsftp_openssl/x509v3.h> /* for GENERAL_NAME etc. */
#include <OpenSSLCrypto/swiftsftp_openssl/cms.h>
